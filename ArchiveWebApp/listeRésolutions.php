    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-space-between mb-4">
                            <a class="btn btn-sm btn-dark fw-bold" href="#modalAddResolution" data-toggle="modal" data-target="#modalAddResolution" style="margin-left: 0px">
                    ...
                    $pageTitle = "Liste des Résolutions";
                    $documentType = "résolutions";
                ...
                <div class="modal fade" id="modalAddResolution" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
