...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($success) {
        ...
        header("Location: ../listeConventions.php?success=1");
        exit;
    } else {
        header("Location: ../listeConventions.php?error=1");
        exit;
    }
}
                ...
                <form action="" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select class="mt-1 block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="docType" name="type" required>
                            ...
                            <option value="convention" <?= $document['type']=='convention'?'selected':''; ?>>Convention</option>
                        </select>
                    </div>
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <a href="../listeConventions.php" class="w-1/2 md:w-auto px-6 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Annuler
                        </a>
                    </div>
                </form>
