...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($success) {
        ...
        header("Location: ../listeRésolutions.php?error=1");
        exit;
    }
}
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
                ...
                <form action="" method="POST" class="space-y-4">
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <a href="../listeRésolutions.php" class="w-1/2 md:w-auto px-6 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Annuler
                        </a>
                    </div>
                </form>
