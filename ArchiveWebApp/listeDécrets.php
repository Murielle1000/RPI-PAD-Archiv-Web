                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-space-between mb-4" >
                            <a class="btn btn-sm btn-dark fw-bold" href="#modalAddDecret" data-toggle="modal" data-target="#modalAddDecret" style="margin-left: 00px">
                        ...
                        <div class="card shadow mb-4" style="border: none; background: linear-gradient(135deg, #2563eb 0%, #60a5fa 100%); color: #fff;">
                            <div class="card-header py-3" style="background: #1e3a8a;">
                                <h6 class="m-0 font-weight-bold" style="color: #fff;">Liste des Décrets</h6>
                            ...
                            <div class="card-body" style="background: #2563eb;">
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="background: #eff6ff; color: #1e3a8a;">
                                        ...
                                        <tbody>
                                            <?php if (count($decrets) > 0): ?>
                                                <?php foreach ($decrets as $decret): ?>
                                                    <tr>
                                                        <td><?= htmlspecialchars($decret['titre']) ?></td>
                                                        <td><?= htmlspecialchars($decret['type']) ?></td>
                                                        <td><?= htmlspecialchars($decret['categorie']) ?></td>
                                                        <td><?= htmlspecialchars($decret['description']) ?></td>
                                                        <td><?= date('d/m/Y H:i', strtotime($decret['add_date'])) ?></td>
                                                        <td>
                                                            <?php if (!empty($decret['url_fichier'])): ?>
                                                                <a href="controller/openDocument.php?id=<?= $decret['id'] ?>"  target="_blank" class="btn btn-sm btn-info">
                                                            ...
                                                            <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                                                                <a href="documentHistory.php?id=<?= $decret['id'] ?>" class="btn btn-sm btn-info" title="Historique des actions"><i class="fas fa-history"></i></a>
                                                                <a href="controller/editDécrets.php?id=<?= $decret['id'] ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                                <a href="controller/deleteDécrets.php?id=<?= $decret['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Supprimer ce document ?');"><i class="fas fa-trash"></i></a>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="6" class="text-center">Aucun décret trouvé.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
